...
function transformDtToInterpolated(input) {
  let result = "";
  let i = 0;
  function extractDtCall(i2) {
    let depth = 1;
    let expr = "dt(";
    i2 += 3;
...
var themeUtils_default2 = {
  ...
  getCommon({ name = "", theme = {}, params, set, defaults }) {
    ...
    if (isNotEmpty(preset) && options.transform !== "strict") {
      ...
      global_css = `${global_light_css}${global_dark_css}`;
      global_tokens = [.../* @__PURE__ */ new Set([...eRest_tokens, ...ecsRest_tokens, ...ecsDark_tokens])];
      style2 = resolve(preset.css, { dt: dt2 });
    }
    return {
      primitive: {
        css: primitive_css,
...
//# sourceMappingURL=chunk-JD6D6TJB.js.map
